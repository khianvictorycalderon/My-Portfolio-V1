...
export default function Home() {
    ...
    const inquire = () => {
        let link = "mailto:khianpublicmail@gmail.com";
                ...
                <div className="box-2x fs-4">
                    <div className="card">
                        ...
                        <ul>
                            ...
                            <li>A chatbot I developed for entertainment purposes. It was built with React and Bootstrap and generates responses without relying on external APIs.</li>
                            <li>Visit <a href="https://kvbot.netlify.app/">HERE</a>.</li>
                        </ul>
                    </div>
                    <div className="card">
                        <b>Article Story</b>
